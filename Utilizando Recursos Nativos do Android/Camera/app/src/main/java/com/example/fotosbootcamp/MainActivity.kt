...
class MainActivity : AppCompatActivity() {
    ...
    private fun openCamera() {
        ...
        val cameraIntente = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
        cameraIntente.putExtra(MediaStore.EXTRA_OUTPUT, image_uri)

        startActivityForResult(cameraIntente, OPEN_CAMERA_CODE)
    }
